...
<qgis version="2.15.2-Dev" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{2d7c7f2e-6713-409d-9a9e-ba1df7abf4aa}">
      <rule filter="typ_kt = 'N527'" key="{d1f92a36-880e-4316-8ba9-435848c62624}" symbol="0" label="527 kantonale Uferschutzzone"/>
      <rule filter="typ_kt = 'N528'" key="{68213f0d-c780-4ba2-8ffe-59af3e9c0f1b}" symbol="1" label="528 kommunale Uferschutzzone ausserhalb Bauzonen"/>
      <rule filter="typ_kt = 'N592'" key="{b65cdf94-5f84-4e2b-ac6f-c1f410512666}" symbol="2" label="592 Hecken, Feldgehölz, Ufergehölz"/>
      <rule filter="typ_kt = 'N610'" key="{c23a9ffc-0c87-46f5-be4c-8c16bf8f3155}" symbol="3" label="610 Perimeter kantonaler Nutzungsplan"/>
      <rule filter="typ_kt = 'N611'" key="{1d136eaf-8176-40d7-92fa-68c285e55b29}" symbol="4" label="611 Perimeter kommunaler Gestaltungsplan"/>
    </rules>
    <symbols>
