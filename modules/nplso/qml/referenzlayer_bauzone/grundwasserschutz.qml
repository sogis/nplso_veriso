...
<qgis version="2.15.2-Dev" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="zone" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="true" symbol="0" value="GZ1" html="" label="Fassungszone S1"/>
      <category render="true" symbol="1" value="GZ1B" html="" label="Fassungszone S1B"/>
      <category render="true" symbol="2" value="GZ2" html="" label="Engere Schutzzone S2"/>
      <category render="true" symbol="3" value="GZ2B" html="" label="Engere Schutzzone S2B"/>
      <category render="true" symbol="4" value="GZ3" html="" label="Weitere Schutzzone S3"/>
      <category render="true" symbol="5" value="GZ3B" html="" label="Weitere Schutzzone S3B"/>
      <category render="true" symbol="6" value="SARE" html="" label="Schutzareale"/>
    </categories>
    <symbols>
    ...
    <source-symbol>
      <symbol alpha="1" type="fill" name="0">
        <layer pass="0" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="216,160,191,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
