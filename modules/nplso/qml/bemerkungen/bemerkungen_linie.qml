...
<qgis version="2.15.2-Dev" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="ValueRelation" name="plan">
      <widgetv2config OrderByValue="1" AllowNull="0" FilterExpression="" fieldEditable="1" Key="plan_txt" Layer="Bemerkungen___Plan20170914140921973" Value="plan_txt" labelOnTop="0" AllowMulti="0"/>
    </edittype>
    <edittype widgetv2type="ValueRelation" name="kommunaler_typ">
      <widgetv2config OrderByValue="1" AllowNull="0" FilterExpression="" fieldEditable="1" Key="kommunaler_typ" Layer="Bemerkungen___kommunaler_Typ20170914140922291" Value="kommunaler_typ" labelOnTop="0" AllowMulti="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="kommunaler_typ" index="2" name="kommunaler Typ:"/>
    <alias field="plan" index="1" name="Plan:"/>
  </aliases>
